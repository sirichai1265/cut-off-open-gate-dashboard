...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .hero-inner{max-width:none;margin:0;display:flex;flex-direction:column;align-items:center;text-align:center;gap:16px;}
  .hero h1{font-size:24px;font-weight:700;margin:0 0 6px;letter-spacing:-.01em;}
  .hero p{font-size:13px;color:#a9bccd;margin:0 auto;max-width:640px;line-height:1.5;}
  .hero-mark{display:flex;align-items:center;justify-content:center;gap:8px;color:#7fa8cb;font-size:11px;text-transform:uppercase;letter-spacing:.08em;font-weight:600;}
