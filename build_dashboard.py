...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .hero-inner{max-width:none;margin:0;display:flex;align-items:flex-end;justify-content:space-between;gap:18px;flex-wrap:wrap;}
  ...
  .hero-brand{display:flex;align-items:center;gap:12px;padding-bottom:14px;margin-bottom:14px;border-bottom:1px solid rgba(255,255,255,.14);}
  .hero-brand svg{height:46px;width:auto;display:block;flex:none;}
  ...
  <div class="hero-inner">
    <div>
      <div class="hero-brand">
        <svg viewBox="0 0 300 52" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="HEUNG A LINE">
          <circle cx="26" cy="26" r="25" fill="#ffffff"/>
          <circle cx="26" cy="26" r="25" fill="none" stroke="#0d5aa7" stroke-width="2"/>
          <circle cx="26" cy="26" r="16" fill="#c8102e"/>
          <path d="M6 31 Q16 23 26 31 T46 31" fill="none" stroke="#ffffff" stroke-width="2.4" stroke-linecap="round"/>
          <text x="26" y="23.5" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" font-weight="700" fill="#ffffff">HAL</text>
          <text x="62" y="24" font-family="Arial, sans-serif" font-size="20" font-weight="700" fill="#ffffff" letter-spacing=".5">HEUNG A LINE</text>
          <text x="63" y="42" font-family="Arial, sans-serif" font-size="10.5" fill="#a9bccd" letter-spacing="1">興亞 LINE 株式會社</text>
        </svg>
      </div>
